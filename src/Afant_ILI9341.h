...
#ifndef _AFANT_ILI9341H_
#define _AFANT_ILI9341H_
...
class Afant_ILI9341 : public Adafruit_GFX {
    protected:

    public:
        Afant_ILI9341(int8_t _CS, int8_t _DC, int8_t _MOSI, int8_t _SCLK, int8_t _RST = -1, int8_t _MISO = -1);
        Afant_ILI9341(int8_t _CS, int8_t _DC, int8_t _RST = -1);
