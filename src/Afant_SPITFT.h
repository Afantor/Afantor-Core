...
#ifndef _AFANT_SPITFT_
#define _AFANT_SPITFT_
...
class Afant_SPITFT : public Adafruit_GFX {
    protected:

    public:
        Afant_SPITFT(uint16_t w, uint16_t h, int8_t _CS, int8_t _DC, int8_t _MOSI, int8_t _SCLK, int8_t _RST = -1, int8_t _MISO = -1);
        Afant_SPITFT(uint16_t w, uint16_t h, int8_t _CS, int8_t _DC, int8_t _RST = -1);
